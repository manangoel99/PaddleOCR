...
- 支持PIP快速安装使用
- 支持训练过程可视化，参数可记录到 [VisualDL](https://www.paddlepaddle.org.cn/documentation/docs/en/guides/03_VisualDL/visualdl_usage_cn.html) 与 [Weights & Biases](docs.wandb.ai)
